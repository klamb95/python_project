...
team_1 = Team("Grange Mens", "Commercial Water Solutions")
team_repository.save(team_1)
team_2 = Team("Grove Menzieshill Hockey", "Focus")
team_repository.save(team_2)
team_3 = Team("Western Wildcats", "Checkpoint Software Technologies")
team_repository.save(team_3)
team_4 = Team("Edinburgh University", "Aratac Hockey")
