...
team_3 = Team("Western Wildcats 1s", "Checkpoint Software Technologies")
team_repository.save(team_3)
team_4 = Team("Edinburgh University 1s", "Aratac Hockey")
team_repository.save(team_4)
team_5 = Team("Clydesdale Hockey Club Mens 1s", "Prosperity Financial Solutions")
team_repository.save(team_5)
team_6 = Team("Uddingston Hockey Club Mens 1s", "Aratac Hockey")
team_repository.save(team_6)
team_7 = Team("Edinburgh University 1s", "Deans Civil Engineering")
team_repository.save(team_7)
team_8 = Team("Kelburne Hockey Club Mens 1s", "Cala Properties")
team_repository.save(team_8)
team_9 = Team("Dundee Wanderers Hockey Club Mens 1s", "MJ Ventilation")
team_repository.save(team_9)
team_10 = Team("The Watsonian Hockey Club Men's 1s", "Avenir Analytics")
